    ...
    <div class="row">
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                ...
                                                <button class="btn btn-outline-danger btn-sm "
                                                    data-pro_id="{{ $user->id }}" data-name="{{ $user->name }}"
                                                    data-toggle="modal" data-target="#modaldemo15">شحن المحفظه</button>
        ...
        <div class="modal fade" id="exampleModal2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">اضافة ملحوظه للعميل </h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <form action="{{ route('user.updateNote') }}" method="post">
                            {{ method_field('post') }}
                            {{ csrf_field() }}
                            ...
                            <label for="note">اضافة
                                ملحوظه للعميل</label>
                            <div class="col-sm-24 col-md-12">
                                <textarea class="form-control" placeholder="اضافة ملحوظه للمستخدم" rows="3" name="note" id="note"></textarea>
                            </div>
        ...
        <div class="modal fade" id="modaldemo15" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">شحن محفظة المستخدم</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <form action="{{ route('user.wallet') }}" method="post">
                        {{ method_field('post') }}
                        {{ csrf_field() }}
                        <div class="modal-body">
                            <p>هل انت متاكد من عملية الشحن ؟</p><br>
                            <input type="hidden" name="pro_id" id="pro_id" value="">
                            <input class="form-control" name="name" id="name" type="text" readonly>
                            <br>
                            <input class="form-control" name="wallet" id="wallet" type="number">
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-dismiss="modal">الغاء</button>
                            <button type="submit" class="btn btn-danger">تاكيد</button>
