    ...
    <div class="row">
        ...
        <div class="col-xl-12">
            <div class="card">
                                ...
                                <div class="d-flex justify-content-between align-items-center mb-3">
                                    ...
                                    <div class="d-flex gap-2">
                                        ...
                                        <button class="btn btn-success" type="button"
                                            ...
                                            استيراد من Excel لاسالة الفقرات
                                        </button>
                                    </div>
                                </div>

                                <!-- Import Form -->
                                <form id="importForm" action="{{ route('vertebrae.import') }}" method="POST"
                ...
                <div class="card-body">
                    <form method="GET" action="{{ route('question_vertebrae.index') }}" class="mb-4">
                        <div class="row">
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                ...
                                <a href="{{ route('question_vertebrae.index', array_merge(request()->only('search'), ['all' => 1])) }}"
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content modal-content-demo">
                    ...
                    <div class="modal-body">
                        <form action="{{ route('question_vertebrae.store') }}" method="post"
        ...
        <div class="modal fade" id="exampleModal2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{ route('question_vertebrae.update', 0) }}" method="post"
        ...
        <div class="modal" id="modaldemo9">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <form action="{{ route('question_vertebrae.destroy', 0) }}" method="post">
                        {{ method_field('DELETE') }}
                        {{ csrf_field() }}
                        <div class="modal-body">
