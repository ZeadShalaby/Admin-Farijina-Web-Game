$(function ()
{
	...
	/* Apexcharts (#bar) */
	function renderDynamicChart(impressionsData, turnoverData, inProgressData, categories)
	{
		var optionsBar = {
			chart: {
				height: 270,
	...
	const url = "https://Al7arm-eg.com/admin-panel/public/dashboard/orders-statistics";

	fetch(url)
		.then(response => response.json())
		.then(data =>
		{
			const impressionsData = data.completedd;
			const turnoverData = data.cancelledd;
			const inProgressData = data.pendingg;
			const categories = data.categories;
			renderDynamicChart(impressionsData, turnoverData, inProgressData, categories);
		})
